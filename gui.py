...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_2.addWidget(self.testButton, 0, QtCore.Qt.AlignBottom)
        ...
        self.gridLayout_5 = QtWidgets.QGridLayout(self.messagesTab)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.gridLayout_9 = QtWidgets.QGridLayout()
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.exact_searchCheckbox = QtWidgets.QCheckBox(self.messagesTab)
        ...
        self.searchLine = QtWidgets.QLineEdit(self.messagesTab)
        ...
        self.linkLine = QtWidgets.QLineEdit(self.messagesTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.linkLine.sizePolicy().hasHeightForWidth())
        self.linkLine.setSizePolicy(sizePolicy)
        self.linkLine.setEchoMode(QtWidgets.QLineEdit.Normal)
        self.linkLine.setReadOnly(True)
        self.linkLine.setCursorMoveStyle(QtCore.Qt.LogicalMoveStyle)
        self.linkLine.setClearButtonEnabled(False)
        self.linkLine.setObjectName("linkLine")
        self.gridLayout_9.addWidget(self.linkLine, 6, 9, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.total_messagesLabel = QtWidgets.QLabel(self.messagesTab)
        ...
        self.messageTree = QtWidgets.QTreeWidget(self.messagesTab)
        self.messageTree.setMouseTracking(True)
        self.messageTree.setAlternatingRowColors(True)
        self.messageTree.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
        self.messageTree.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        ...
        self.hideButton = QtWidgets.QToolButton(self.messagesTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        ...
        self.horizontalLayout_5.addWidget(self.hideButton, 0, QtCore.Qt.AlignHCenter)
        self.undoButton = QtWidgets.QToolButton(self.messagesTab)
        ...
        self.undoButton.setMinimumSize(QtCore.QSize(28, 22))
        self.undoButton.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.undoButton.setPopupMode(QtWidgets.QToolButton.MenuButtonPopup)
        self.undoButton.setObjectName("undoButton")
        self.horizontalLayout_5.addWidget(self.undoButton, 0, QtCore.Qt.AlignHCenter)
        ...
        self.photoTab.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.photoTab.setObjectName("photoTab")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.photoTab)
        ...
        self.gridLayout_7 = QtWidgets.QGridLayout(self.analysisTab)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.analysis_stickers_amountLabel = QtWidgets.QLabel(self.analysisTab)
        ...
        self.analysis_symbols_amountLabel = QtWidgets.QLabel(self.analysisTab)
        ...
        self.analysis_emoji_amountLabel = QtWidgets.QLabel(self.analysisTab)
        ...
        self.label_9 = QtWidgets.QLabel(self.analysisTab)
        self.label_9.setObjectName("label_9")
        self.gridLayout_7.addWidget(self.label_9, 7, 0, 1, 1)
        self.analysis_words_amountLabel = QtWidgets.QLabel(self.analysisTab)
        ...
        self.analysis_emojisTree = QtWidgets.QTreeWidget(self.tab_3)
        ...
        self.settings_tabWidget = QtWidgets.QTabWidget(self.tab_4)
        self.settings_tabWidget.setMaximumSize(QtCore.QSize(16777215, 162))
        self.settings_tabWidget.setTabPosition(QtWidgets.QTabWidget.North)
        self.settings_tabWidget.setTabShape(QtWidgets.QTabWidget.Rounded)
        self.settings_tabWidget.setObjectName("settings_tabWidget")
        self.textTab = QtWidgets.QWidget()
        self.textTab.setObjectName("textTab")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.textTab)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.symbLayout = QtWidgets.QGridLayout()
        self.symbLayout.setObjectName("symbLayout")
        self.and_orCombobox = QtWidgets.QComboBox(self.textTab)
        ...
        self.min_symbolsCombobox = QtWidgets.QComboBox(self.textTab)
        ...
        self.min_symbolsSpinbox = QtWidgets.QSpinBox(self.textTab)
        ...
        self.min_wordsCheckbox = QtWidgets.QCheckBox(self.textTab)
        ...
        self.min_wordsCombobox = QtWidgets.QComboBox(self.textTab)
        ...
        self.min_wordsSpinbox = QtWidgets.QSpinBox(self.textTab)
        ...
        self.verticalLayout_6.addWidget(self.fileButton, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.verticalLayout_6.addWidget(self.settingsButton, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.hastextButton = QtWidgets.QToolButton(self.settingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icons/hastext.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.hastextButton.setIcon(icon2)
        self.hastextButton.setIconSize(QtCore.QSize(24, 24))
        self.hastextButton.setCheckable(True)
        self.hastextButton.setAutoRaise(True)
        self.hastextButton.setObjectName("hastextButton")
        self.settingsLayout.addWidget(self.hastextButton, 0, QtCore.Qt.AlignHCenter)
        self.notextButton = QtWidgets.QToolButton(self.settingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icons/notext.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.notextButton.setIcon(icon3)
        self.notextButton.setIconSize(QtCore.QSize(24, 24))
        self.notextButton.setCheckable(True)
        self.notextButton.setAutoRaise(True)
        self.notextButton.setObjectName("notextButton")
        self.settingsLayout.addWidget(self.notextButton, 0, QtCore.Qt.AlignHCenter)
        self.emojiButton = QtWidgets.QToolButton(self.settingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.emojiButton.sizePolicy().hasHeightForWidth())
        self.emojiButton.setSizePolicy(sizePolicy)
        self.emojiButton.setLayoutDirection(QtCore.Qt.LeftToRight)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("icons/emoji-enabled.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.emojiButton.setIcon(icon4)
        self.emojiButton.setIconSize(QtCore.QSize(24, 24))
        ...
        self.settingsLayout.addWidget(self.emojiButton, 0, QtCore.Qt.AlignHCenter)
        self.lengthButton = QtWidgets.QToolButton(self.settingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lengthButton.sizePolicy().hasHeightForWidth())
        self.lengthButton.setSizePolicy(sizePolicy)
        self.lengthButton.setLayoutDirection(QtCore.Qt.LeftToRight)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("icons/length.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.lengthButton.setIcon(icon5)
        self.lengthButton.setIconSize(QtCore.QSize(24, 24))
        ...
        self.settingsLayout.addWidget(self.lengthButton, 0, QtCore.Qt.AlignHCenter)
        spacerItem13 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.settingsLayout.addItem(spacerItem13)
        self.forwardButton = QtWidgets.QToolButton(self.settingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.forwardButton.sizePolicy().hasHeightForWidth())
        self.forwardButton.setSizePolicy(sizePolicy)
        self.forwardButton.setLayoutDirection(QtCore.Qt.LeftToRight)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("icons/forward-enabled.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.settingsLayout.addWidget(self.forwardButton, 0, QtCore.Qt.AlignHCenter)
        self.attachmentButton = QtWidgets.QToolButton(self.settingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.attachmentButton.setLayoutDirection(QtCore.Qt.LeftToRight)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("icons/attachment-enabled.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.attachmentButton.setIcon(icon7)
        self.attachmentButton.setIconSize(QtCore.QSize(24, 24))
        ...
        self.settingsLayout.addWidget(self.attachmentButton, 0, QtCore.Qt.AlignHCenter)
        ...
        self.voiceButton = QtWidgets.QToolButton(self.settingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.voiceButton.sizePolicy().hasHeightForWidth())
        self.voiceButton.setSizePolicy(sizePolicy)
        self.voiceButton.setLayoutDirection(QtCore.Qt.LeftToRight)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("icons/voice-enabled.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.voiceButton.setIcon(icon8)
        self.voiceButton.setIconSize(QtCore.QSize(24, 24))
        ...
        self.settingsLayout.addWidget(self.voiceButton, 0, QtCore.Qt.AlignHCenter)
        self.graffitiButton = QtWidgets.QToolButton(self.settingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.graffitiButton.setLayoutDirection(QtCore.Qt.LeftToRight)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("icons/graffiti-enabled.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.graffitiButton.setIcon(icon9)
        self.graffitiButton.setIconSize(QtCore.QSize(24, 24))
        ...
        self.settingsLayout.addWidget(self.graffitiButton, 0, QtCore.Qt.AlignHCenter)
        self.stickerButton = QtWidgets.QToolButton(self.settingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.stickerButton.sizePolicy().hasHeightForWidth())
        self.stickerButton.setSizePolicy(sizePolicy)
        self.stickerButton.setLayoutDirection(QtCore.Qt.LeftToRight)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("icons/sticker-enabled.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.stickerButton.setIcon(icon10)
        self.stickerButton.setIconSize(QtCore.QSize(24, 24))
        ...
        self.settingsLayout.addWidget(self.stickerButton, 0, QtCore.Qt.AlignHCenter)
        self.verticalLayout_6.addWidget(self.settingsWidget)
        ...
        self.applyButton = QtWidgets.QToolButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.applyButton.sizePolicy().hasHeightForWidth())
        self.applyButton.setSizePolicy(sizePolicy)
        self.applyButton.setLayoutDirection(QtCore.Qt.LeftToRight)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("icons/apply.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.verticalLayout_6.addWidget(self.applyButton, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.browseButton.setText(_translate("MainWindow", "Открыть файл"))
